...
func NewFlatLeaf32(h30 uint32, key Key, val interface{}) *flatLeaf32 {
...
func (l flatLeaf32) get(key Key) (interface{}, bool) {
	if l.key.Equals(key) {
		return l.val, true
	}
	return nil, false
...
func (l flatLeaf32) put(key Key, val interface{}) (leaf32I, bool) {
	if l.key.Equals(key) {
		l.val = val
		return l, false
	}
...
func (l flatLeaf32) del(key Key) (interface{}, leaf32I, bool) {
	if l.key.Equals(key) {
